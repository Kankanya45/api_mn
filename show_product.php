...
if (isset($_POST['id_product'])) {
    ...
    $id_product = filter_input(INPUT_POST, 'id_product', FILTER_SANITIZE_STRING);

    // Prepare and execute the SQL query
    $sql = "SELECT * FROM product_data WHERE id_product = ?";
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, 's', $id_product);
